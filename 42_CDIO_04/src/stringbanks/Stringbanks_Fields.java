...
public class Stringbanks_Fields {
	...
	private String field2Description = "Leje af grund: Kr. 50 <br> m/1 hus: 250"
			+ "<br> m/2 huse: Kr. 750 <br> m/3 huse: Kr. 2.250 <br> m/4 huse: Kr. 4.000 <br> m/ hotel: Kr. 6.000"
			+ "<br> Pantsætningsværdi: Kr. 600 <br> Hvert hus koster: Kr. 1.000";
	private String field2subtext = "";
	
	private String field3Name = "Hvidovrevej"; 
	private String field3Description = "Leje af grund: Kr. 50 <br> m/1 hus: 250"
			+ "<br> m/2 huse: Kr. 750 <br> m/3 huse: Kr. 2.250 <br> m/4 huse: Kr. 4.000 <br> m/ hotel: Kr. 6.000"
			+ "<br> Pantsætningsværdi: Kr. 600 <br> Hvert hus koster: Kr. 1.000";
	private String field3subtext = "";

	private String field4Name = "Roskildevej"; 
	private String field4Description = "Leje af grund: Kr. 100 <br> m/1 hus: 600"
			+ "<br> m/2 huse: Kr. 1.800 <br> m/3 huse: Kr. 5.400 <br> m/4 huse: Kr. 8.000 <br> m/ hotel: Kr. 11.000"
			+ "<br> Pantsætningsværdi: Kr. 1.000 <br> Hvert hus koster: Kr. 1.000";
	private String field4subtext = "";
	
	private String field5Name = "Valby Langgade";
	private String field5Description = "Leje af grund: Kr. 100 <br> m/1 hus: 600"
			+ "<br> m/2 huse: Kr. 1.800 <br> m/3 huse: Kr. 5.400 <br> m/4 huse: Kr. 8.000 <br> m/ hotel: Kr. 11.000"
			+ "<br> Pantsætningsværdi: Kr. 1.000 <br> Hvert hus koster: Kr. 1.000";
	private String field5subtext = "";
	
	private String field6Name = "Allégade";
	private String field6Description = "Leje af grund: Kr. 150 <br> m/1 hus: 800"
			+ "<br> m/2 huse: Kr. 2.000 <br> m/3 huse: Kr. 6.000 <br> m/4 huse: Kr. 9.000 <br> m/ hotel: Kr. 12.000"
			+ "<br> Pantsætningsværdi: Kr. 1.200 <br> Hvert hus koster: Kr. 1.000";
	private String field6subtext = "";
	
	private String field7Name = "Frederiksberg Allé";
	private String field7Description = "Leje af grund: Kr. 200 <br> m/1 hus: 1.000"
			+ "<br> m/2 huse: Kr. 3.000 <br> m/3 huse: Kr. 9.000 <br> m/4 huse: Kr. 12.500 <br> m/ hotel: Kr. 15.000"
			+ "<br> Pantsætningsværdi: Kr. 1.400 <br> Hvert hus koster: Kr. 2.000";
	private String field7subtext = "";
	
	private String field8Name = "Bülowsvej";
	private String field8Description = "Leje af grund: Kr. 200 <br> m/1 hus: 1.000"
			+ "<br> m/2 huse: Kr. 3.000 <br> m/3 huse: Kr. 9.000 <br> m/4 huse: Kr. 12.500 <br> m/ hotel: Kr. 15.000"
			+ "<br> Pantsætningsværdi: Kr. 1.400 <br> Hvert hus koster: Kr. 2.000";
	private String field8subtext = "";
	
	private String field9Name = "Gl Kongevej";
	private String field9Description = "Leje af grund: Kr. 250 <br> m/1 hus: 1.250"
			+ "<br> m/2 huse: Kr. 3.750 <br> m/3 huse: Kr. 10.000 <br> m/4 huse: Kr. 14.000 <br> m/ hotel: Kr. 18.000"
			+ "<br> Pantsætningsværdi: Kr. 1.600 <br> Hvert hus koster: Kr. 2.000";
	private String field9subtext = "";
	
	private String field10Name = "Bernstorffsvej";
	private String field10Description = "Leje af grund: Kr. 300 <br> m/1 hus: 1.400"
			+ "<br> m/2 huse: Kr. 4.000 <br> m/3 huse: Kr. 11.000 <br> m/4 huse: Kr. 15.000 <br> m/ hotel: Kr. 19.000"
			+ "<br> Pantsætningsværdi: Kr. 1.800 <br> Hvert hus koster: Kr. 2.000";
	private String field10subtext = "";
	
	private String field11Name = "Hellerupvej";
	private String field11Description = "Leje af grund: Kr. 300 <br> m/1 hus: 1.400"
			+ "<br> m/2 huse: Kr. 4.000 <br> m/3 huse: Kr. 11.000 <br> m/4 huse: Kr. 15.000 <br> m/ hotel: Kr. 19.000"
			+ "<br> Pantsætningsværdi: Kr. 1.800 <br> Hvert hus koster: Kr. 2.000";
	private String field11subtext = "";

	private String field12Name = "Strandvejen";
	private String field12Description = "Leje af grund: Kr. 350 <br> m/1 hus: 1.600"
			+ "<br> m/2 huse: Kr. 4.400 <br> m/3 huse: Kr. 12.000 <br> m/4 huse: Kr. 16.000 <br> m/ hotel: Kr. 20.000"
			+ "<br> Pantsætningsværdi: Kr. 2.000 <br> Hvert hus koster: Kr. 2.000";
	private String field12subtext = "";
	
	private String field13Name = "Trianglen";
	private String field13Description = "Leje af grund: Kr. 350 <br> m/1 hus: 1.800"
			+ "<br> m/2 huse: Kr. 5.000 <br> m/3 huse: Kr. 14.000 <br> m/4 huse: Kr. 17.500 <br> m/ hotel: Kr. 21.000"
			+ "<br> Pantsætningsværdi: Kr. 2.200 <br> Hvert hus koster: Kr. 3.000";
	private String field13subtext = "";
	
	private String field14Name = "Østerbrogade";
	private String field14Description = "Leje af grund: Kr. 350 <br> m/1 hus: 1.800"
			+ "<br> m/2 huse: Kr. 5.000 <br> m/3 huse: Kr. 14.000 <br> m/4 huse: Kr. 17.500 <br> m/ hotel: Kr. 21.000"
			+ "<br> Pantsætningsværdi: Kr. 2.200 <br> Hvert hus koster: Kr. 3.000";
	private String field14subtext = "";
	
	private String field15Name = "Grønningen";
	private String field15Description = "Leje af grund: Kr. 400 <br> m/1 hus: 2.000"
			+ "<br> m/2 huse: Kr. 6.000 <br> m/3 huse: Kr. 15.000 <br> m/4 huse: Kr. 18.500 <br> m/ hotel: Kr. 22.000"
			+ "<br> Pantsætningsværdi: Kr. 2.400 <br> Hvert hus koster: Kr. 3.000";
	private String field15subtext = "";
	
	private String field16Name = "Bredgade";
	private String field16Description = "Leje af grund: Kr. 450 <br> m/1 hus: 2.200"
			+ "<br> m/2 huse: Kr. 6.600 <br> m/3 huse: Kr. 16.000 <br> m/4 huse: Kr. 19.500 <br> m/ hotel: Kr. 23.000"
			+ "<br> Pantsætningsværdi: Kr. 2.600 <br> Hvert hus koster: Kr. 3.000";
	private String field16subtext = "";
	
	private String field17Name = "Kgs Nytorv";
	private String field17Description = "Leje af grund: Kr. 450 <br> m/1 hus: 2.200"
			+ "<br> m/2 huse: Kr. 6.600 <br> m/3 huse: Kr. 16.000 <br> m/4 huse: Kr. 19.500 <br> m/ hotel: Kr. 23.000"
			+ "<br> Pantsætningsværdi: Kr. 2.600 <br> Hvert hus koster: Kr. 3.000";
	private String field17subtext = "";
	
	private String field18Name = "Østergade";
	private String field18Description = "Leje af grund: Kr. 500 <br> m/1 hus: 2.400"
			+ "<br> m/2 huse: Kr. 7.200 <br> m/3 huse: Kr. 17.000 <br> m/4 huse: Kr. 20.500 <br> m/ hotel: Kr. 24.000"
			+ "<br> Pantsætningsværdi: Kr. 2.800 <br> Hvert hus koster: Kr. 3.000";
	private String field18subtext = "";
	
	private String field19Name = "Amargertorv";
	private String field19Description = "Leje af grund: Kr. 550 <br> m/1 hus: 2.600"
			+ "<br> m/2 huse: Kr. 7.800 <br> m/3 huse: Kr. 18.000 <br> m/4 huse: Kr. 22.000 <br> m/ hotel: Kr. 25.000"
			+ "<br> Pantsætningsværdi: Kr. 3.000 <br> Hvert hus koster: Kr. 4.000";
	private String field19subtext = "";

	private String field20Name = "Vimmelskaftet";
	private String field20Description = "Leje af grund: Kr. 550 <br> m/1 hus: 2.600"
			+ "<br> m/2 huse: Kr. 7.800 <br> m/3 huse: Kr. 18.000 <br> m/4 huse: Kr. 22.000 <br> m/ hotel: Kr. 25.000"
			+ "<br> Pantsætningsværdi: Kr. 3.000 <br> Hvert hus koster: Kr. 4.000";
	...
	private String field23Description = "Leje af grund: Kr. 1.000 <br> m/1 hus: 4.000"
			+ "<br> m/2 huse: Kr. 12.000 <br> m/3 huse: Kr. 28.000 <br> m/4 huse: Kr. 34.000 <br> m/ hotel: Kr. 40.000"
			+ "<br> Pantsætningsværdi: Kr. 4.000 <br> Hvert hus koster: Kr. 4.000";
	...
	private String field25Description = "Pris: Kr. 4.000 <br> Leje af grund: Kr. 500 <br>"
			+ "Hvis 2 rederier ejes: Kr. 1.000<br> Hvis 3 rederier ejes: Kr. 2.000 <br> "
			+ "Hvis 4 rederier ejes: Kr. 4.000 <br> "
			+ "Pantsætningsværdi: Kr. 2.000";
	...
	private String field28Description = "Betal indkomstskat: <br> 10% eller kr. 4.000";
	private String field28subtext = "Betal indkomstskat: <br> 10% eller kr. 4.000";
	
	private String field29Name = "Statsskat";
	private String field29Description = "Ekstraordinær statsskat: <br> Betal kr. 2.000";
	private String field29subtext = "Ekstraordinær statsskat: <br> Betal kr. 2.000";
	
	//Jail information	
	private String field30Name = "Fængsel";
	private String field30Description = "På besøg";
